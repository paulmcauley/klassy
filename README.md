...
## Installation
_Klassy_ version 6.0.1 requires at least __Plasma 6.0__, so please check you have this in kinfocenter before trying to install. You can either download the pre-built packages or compile from source.
<a name="prebuilt"/>
