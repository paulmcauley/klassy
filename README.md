...
### Pre-built packages
[Respositories are available from the Open Build Service](https://software.opensuse.org/download.html?project=home%3Apaulmcauley&package=klassy) for OpenSUSE, Debian/Ubuntu, Fedora, Mageia and Arch/Manjaro to keep you on the latest version. A KDE Neon package [can be downloaded here](https://github.com/paulmcauley/klassy/releases/download/v6.5.2/klassy_6.5.2-1_amd64_KDE_Neon.deb).
