...
namespace Breeze
{
    ...
    class Helper : public QObject
    {
        ...
        //* tabbar tab
        void renderTabBarTab( QPainter*, const QRect&, const QPalette& palette, const QHash<QByteArray, bool>& stateProperties, Corners corners, qreal animation ) const;
        ...
        void renderDecorationButton( QPainter*, const QRect&, const QColor&, ButtonType, bool inverted, bool paintBackground = false, const QColor& backgroundColor = QColor(), const QColor& outlineColor = QColor(), const qreal devicePixelRatio = 1) const;
